...
if ("function" == typeof Object.defineProperty) {
    ...
    Array.prototype.shuffle = function() {
        for (var e, f, d = this.length; d; e = parseInt(Math.random() * d),
        f = this[--d],
        this[d] = this[e],
        this[e] = f) {}
        return this
...
var array_shuffle = function(f) {
    for (var h, e, g = f.length; g; h = parseInt(Math.random() * g),
    e = f[--g],
    f[g] = f[h],
    f[h] = e) {}
    return f
  ...
  , utils = {
    ...
    HashManage: {
        ...
        _change: function(w, u) {
            var v = location.hash
              ...
              , r = 0;
            v && (v = v.substring(1),
            this.prependHash && (v = v.replace(RegExp("^" + this.prependHash.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g, "\\$&")), "")));
            for (var v = v.split("&"), q = 0; q < v.length; q++) {
                var p = v[q].split("=")[0]
                  , j = v[q].split("=")[1];
                p && (t[p] = decodeURIComponent(j))
            }
            if ("object" == typeof w) {
                for (var o in w) {
                    (v = w[o]) ? t[o] = encodeURIComponent(v) : !1 === v && delete t[o]
                }
            } else {
                if (u) {
    ...
    getColor16: function(f) {
        ...
        g = e(g)) : null != f.match(/,+/g) ? (g = f.split(","),
        g = e(g)) : g = h(f);
        return g
    },
    ...
    throttle: function(i, o, h) {
        ...
        function l() {
            ...
            !j && h.head && (j = a);
            b = o - (a - j);
            0 >= b || b > o ? (clearTimeout(k),
            k = null,
            j = a,
            i()) : k || h.tail || (k = setTimeout(n, b))
        }
        var k, j = 0;
        o = o || 200;
        h = h || {};
    ...
    webp: function(j, q) {
        ...
        var p = /\/\d+?_\d+?\/bfs/
          , o = i.replace(p, "/bfs");
        p.test(i) ? (/\/(\d+?)_(\d+?)\/bfs\/\w+?\/.+?(\.\w{3,4})/.exec(i),
        i = o + "_" + RegExp.$1 + "x" + RegExp.$2 + RegExp.$3) : i = !1;
        j = i ? i : j;
        o = "";
        i = j.match(/_(\d+)x(\d+)./);
    ...
    isAlpha: function(e, f) {
        var d;
        localStorage.getItem("machineDna") ? d = localStorage.getItem("machineDna") : (d = parseInt(10 * Math.random() + 1),
        localStorage.setItem("machineDna", d));
    ...
    lockPageScroll: function(e) {
        ...
        "lock" == e ? (window.addEventListener && window.addEventListener("DOMMouseScroll", this.preventDefault, !1),
        window.onwheel = this.preventDefault,
        window.onmousewheel = document.onmousewheel = this.preventDefault,
        window.ontouchmove = this.preventDefault,
        document.onkeydown = f) : "unlock" == e && (window.removeEventListener && window.removeEventListener("DOMMouseScroll", this.preventDefault, !1),
...
MessageBox.prototype = {
    ...
    show: function(i, o, h, n, l) {
        ...
        if (!1 != this.params.Overlap || "yes" != i.attr("hasMessageBox")) {
            ...
            "over" == this.params.evType ? (i.bind("mouseleave", j.leftTimer),
            i.bind("mouseenter", j.incomingTimer),
...
function pagelist(w, u, v, t, s, r, q, p) {
    q = q ? q : 3;
    u = parseInt(u);
    v = parseInt(v);
    t = parseInt(t);
    ...
    u != v && 1 < v && (u <= v - q - 1 && o != v && (o + 1 != v && $("<strong>...</strong>").appendTo(w),
    $('<a class="p endPage" href="javascript:;" page="' + v + '">' + v + "</a>").appendTo(w).click(function() {
        s($(this).attr("page"))
    })),
...
window.bbFeedback = function() {
    function y(f, e, h) {
        f = j.base + j.list.getReply + "?type=1&sort=0&oid=" + f + "&pn=" + e + "&r=" + Math.random();
        if (f != q) {
            q = f;
            $(".comm > .loading").remove();
    ...
    function w(f, e, h) {
        f = j.base + j.list.getReply + "?type=2&sort=0&oid=" + f + "&pn=" + e + "&r=" + Math.random();
        if (f != q) {
            q = f;
            $(".comm > .loading").remove();
            $('<div class="loading"></div>').prependTo(".comm");
    ...
    function x(k, h, A, z, p, n) {
        ...
        h = {
            ...
            success: function(a) {
                ...
                0 != a.code ? 12004 == a.code ? l.show(k, "\u60a8\u7684\u64cd\u4f5c\u8fc7\u4e8e\u9891\u7e41\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5", 2000, "info") : l.show(k, "\u64cd\u4f5c\u5931\u8d25", 2000, "info") : (1 == p ? l.show(k, "\u8d5e\u540c\u6210\u529f", 500, "info") : 0 == p && l.show(k, "\u53d6\u6d88\u8d5e\u540c\u6210\u529f", 500, "info"),
                n && n())
            },
            error: function() {
    ...
    function v(g, f, l, k, h) {
        f = {
            type: "post",
            url: j.base + (h ? j.list.upHide : j.list.upShow),
            data: $.extend(!0, {
                jsonp: "jsonp"
            }, {
                oid: f,
            ...
            success: function(a) {
                a && 0 == a.code ? ((new MessageBox).show(g, h ? "\u9690\u85cf\u6210\u529f" : "\u663e\u793a\u6210\u529f", 500, "info"),
                h ? $(g).parent().find(".showfb").css("display", "") : $(g).parent().find(".hidefb").css("display", ""),
                $(g).hide()) : (new MessageBox).show(g, h ? "\u9690\u85cf\u5931\u8d25" : "\u663e\u793a\u5931\u8d25", 2000, "warning")
            },
            error: function() {
        ...
        var A = new MessageBox
          ...
          , p = A.show(E, '<h3 style="text-align:left; color: #333;font-size: 14px;">\u8bf7\u8f93\u5165\u4e3e\u62a5\u7406\u7531</h3><span class="b-btn-cancel-copy" style="color:#999;cursor:pointer;position:absolute;right:10px;top:8px;font-size:14px;font-family:Arial;">\u00d7</span><div class="reason-set"></div><textarea style="display:none;width:188px;border-radius:4px;border:1px solid #ccd0d7;height:58px;padding:5px;margin:5px 0;" name="message" placeholder="\u81ea\u5b9a\u4e49\u7406\u7531"></textarea>', "button", function() {
            ...
            $.ajax({
                ...
                (new MessageBox).show(b, "\u63d0\u4ea4\u5931\u8d25\uff0c\u8bf7\u91cd\u8bd5")
            }).complete(function() {
                b.css({
                    "background-color": "",
                    color: ""
    ...
    function t(g) {
        ...
        if (g > l && 0 <= f - g) {
            return 50 >= f - g ? (f = 10 * Math.floor((f - g) % 60 / 10),
            (10 < g ? f : 10) + "\u79d2\u524d") : 3600 > f - g ? Math.ceil((f - g) / 60) + "\u5206\u949f\u524d" : Math.ceil((f - g) / 3600) + "\u5c0f\u65f6\u524d"
        }
        f = new Date;
        f.setTime(1000 * g);
        g = f.getMonth() + 1;
    ...
    function o(e, d, f) {
        ...
        this.platform = "pc";
        browser.version.mobile && !browser.version.iPad ? (this.target.removeClass("pc").addClass("mobile"),
        this.platform = "mobile") : browser.version.iPad || browser.version.android ? (this.target.removeClass("pc"),
        this.platform = "tablet") : this.target.addClass("pc");
        ...
        case 1:
            ...
            if (0 == $("#review_comments_tips").length) {
                $('<div class="new_comm"><span id="review_comments_tips" tag="0"></span></div>').prependTo(a ? "#comment_container>ul" : ".bilibili-comment > ul").on("click", function() {
                    window.feedback_object ? (window.feedback_object.orderby = "0",
                    window.feedback_object.load(1)) : 0 < $("#fb_tp_id").length ? w($("#fb_tp_id").val(), 1) : 0 < $("#fb_aid").length ? y($("#fb_aid").val(), 1) : y($("#fb_news_id").val(), 1)
                })
            }
    ...
    o.prototype = {
        ...
        init: function() {
            ...
            if (this.options.useIframe) {
                try {
                    if (window.parent && window.parent.document) {
                        ...
                        k && (f = this.bindWindow = window.parent,
                        l = this.bindTarget = k)
                    }
                } catch (h) {
                    throw h
            ...
            this.options.autoLoad && ($("#load_comment").remove(),
            $(this.target).show(),
        ...
        checkLogin: function(d) {
            if (this.loginInfo && $(".tg_send_post", this.target).length) {
                ...
                if (this.loginInfo.isLogin) {
                    ...
                    UserStatus.checkMoral() ? this.loginInfo.level_info && 2 > this.loginInfo.level_info.current_level && this.loginInfo.officialVerify && -1 == this.loginInfo.officialVerify.type && window.uid && window.uid != window.mid && !(0 < this.loginInfo.vipType && 0 != this.loginInfo.vipStatus && 2 != this.loginInfo.vipStatus && 3 != this.loginInfo.vipStatus) ? (c.addClass("disabled"),
                    $('<div class="login-link-wrp">\u60a8\u7684\u7b49\u7ea7\u4e0d\u8db3\uff0c\u5347\u7ea7\u81f3Lv2\u53ef\u53c2\u4e0e\u8bc4\u8bba</div>').prependTo($(".dcmp-textarea-container").addClass("disabled"))) : ($(".dcmp-textarea-container", d).removeClass("disabled"),
                    c.removeClass("disabled"),
                    $(".jc-notice", d).remove(),
                    d.find(".ipt-txt").show()) : (c.addClass("disabled"),
                    $('<div class="login-link-wrp">\u4f60\u7684\u8282\u64cd\u5df2\u4f4e\u4e8e60\uff0c\u5c06\u65e0\u6cd5\u53d1\u8868\u8bc4\u8bba\uff0c\u8be6\u60c5\u8bf7\u70b9\u51fb<a class="login-link b-btn" href="https://account.bilibili.com/site/record?type=moral" target="_blank">\u6211\u7684\u8282\u64cd\u8bb0\u5f55</a><a class="jc-help" href="//www.bilibili.com/html/help.html#j_4" target="_blank"><i class="b-tip jc"></i>\u5982\u4f55\u6062\u590d\u8282\u64cd\u503c\uff1f</a></div>').prependTo($(".dcmp-textarea-container").addClass("disabled"))),
                    !0
                }
                $(".user_face", d).addClass("no-face");
                $(".user_face>img", d).attr("src", "//static.hdslb.com/images/member/noface.gif");
                0 == d.find(".login-link").length && (c.addClass("disabled"),
                $('<div class="login-link-wrp">\u8bf7\u5148<a class="login-link b-btn" href="https://account.bilibili.com/login" target="_blank">\u767b\u5f55</a>\u540e\u53d1\u8868\u8bc4\u8bba (\u30fb\u03c9\u30fb)</div>').prependTo($(".dcmp-textarea-container").addClass("disabled")).find(".login-link").on("click", function(b) {
        ...
        pushUser: function(d, c) {
            ...
            return 0 > this.mids.indexOf(d) && 0 > this.hasFeedMids.indexOf(d) ? (this.mids.push(d),
            !0) : !1
        },
            ...
            for (var f = 0; f < this.hasFeedMids.length; f++) {
                for (var e = 0; e < this.floorObjs[this.hasFeedMids[f]].length; e++) {
                    ...
                    if (!(0 < h.find(".feedtag").length)) {
                        ...
                        0 < h.length && (h = parseInt(h.attr("rank")),
                        3 >= h && g.addClass("n n" + h))
                    }
                }
            }
        },
        initEmoji: function(g) {
            ...
            $(document.body).on("click", function(a) {
                g.find(".dcmp_post").find(a.target).length || 1 != l || (k.removeClass("open"),
                h.removeClass("open"),
                l = 0)
            });
            k.click(function() {
                0 == l ? ($(this).addClass("open"),
                h.addClass("open"),
                l = 1,
                $(".ipt-txt", g).focus()) : ($(this).removeClass("open"),
                h.removeClass("open"),
                l = 0)
            });
            h.on("click", ".emoji-wrap a", function() {
                UserStatus.isLogin(this) && (s($(".ipt-txt", g).get(0), $(this).text()),
                $(".ipt-txt", g).removeClass("error").parent().removeClass("error"),
                k.removeClass("open"),
                h.removeClass("open"),
                l = 0)
            });
            h.on("click", ".emoji-wrap span", function() {
                if (UserStatus.isLogin(this)) {
                    if (f.loginInfo.isLogin && 0 < f.loginInfo.vipType && 0 != f.loginInfo.vipStatus) {
                        1 == f.loginInfo.vipStatus ? (s($(".ipt-txt", g).get(0), $(this).attr("data-emoji-text")),
                        $(".ipt-txt", g).removeClass("error").parent().removeClass("error"),
                        k.removeClass("open"),
                        h.removeClass("open"),
                        l = 0) : 2 == f.loginInfo.vipStatus && $.ajax({
        ...
        loadReply: function(g, f, l, k) {
            ...
            $.ajax({
                dataType: "jsonp",
                url: j.base + j.list.getChildReply + "?jsonp=jsonp&root=" + l + "&type=" + (4 == h.type ? 4 : "topic" == h.type ? 2 : 1) + "&oid=" + h.id + "&ps=10&pn=" + k + "&r=" + Math.random(),
                success: function(b) {
                    b = b.data;
                    $(f).empty();
                    $(g).empty().attr({
                ...
                success: function(h) {
                    if (0 == h.code) {
                        ...
                        if (k) {
                            var d = D.parent()
                              , a = d.find(".re_ul")
                              , g = d.find(".pagelistbox")
                              , b = parseInt(g.attr("data-page"))
                              , e = parseInt(g.attr("data-results")) || a.children().length;
                            (d.find(".re_more").length || b) && b != Math.ceil(e / 10) || setTimeout(function() {
                                p.loadReply(g, a, n || k, Math.ceil((e + 1) / 10))
                            }, 200)
                        }
                        p.removeCaptcha();
                        p._trigger("onSubmit")
                        ...
                        if (h) {
                            ...
                            case 12014:
                                ...
                                break;
                            case 12015:
                                D.find(".fb-vcode-wrp").length ? (d = "\u9a8c\u8bc1\u7801\u9519\u8bef",
                                $("#fb_vcode").val(""),
                                p.target.find(".tg_send_post .fb-vcode-wrp img").eq(0).click()) : d = "\u8bf7\u586b\u5199\u9a8c\u8bc1\u7801";
                    ...
                    h && h.data && (h.data.need_captcha ? h.data.url && p.createCaptcha(D, h.data.url) : (p.needCaptcha = !1,
                    p.removeCaptcha()))
                },
                error: function() {
        ...
        re_send_show: function(k, g, A, z, p) {
            ...
            if (0 == k.children().length) {
                ...
                $(".comm_send", n.target).html(),
                k.append(n.emojiDefault),
                n.checkLogin(k),
                ...
                this.initEmoji(k),
                k.find(".ipt-txt").val(""),
                null != g && s($(".ipt-txt", k).get(0), "\u56de\u590d @" + g + " :"),
                $(".ipt-txt", k).hover(function() {
                ...
                !this.loginInfo.isLogin) {
                    k.find(".login-link").off("click").on("click", function(b) {
                        UserStatus.isLogin($(this), b)
                    })
                }
            } else {
                null != g ? (k.show(),
                k.find(".ipt-txt").val(""),
                s($(".ipt-txt", k).get(0), "\u56de\u590d @" + g + " :")) : "" == k.find(".ipt-txt").val() || k.parent().hasClass("empty") ? (g = 0 == h.find(".re_ul").children().length ? !0 : !1,
                "none" != k.css("display") ? (k.hide(),
                g && h.hide()) : (k.show(),
                g && h.show())) : k.find(".ipt-txt").val("")
            }
        ...
        createCaptcha: function(f, e) {
            var h = this.target.find(".tg_send_post"), g;
            h.find(".fb-vcode-wrp").length && !e ? g = h.find(".fb-vcode-wrp> img").attr("src") : e && (g = e);
            h.each(function(k, d) {
                var l = $(d);
                l.find(".fb-vcode-wrp").length && l.find(".fb-vcode-wrp").is(":visible") || (l.find(".fb-vcode-wrp").remove(),
                $('<div class="fb-vcode-wrp">\u9a8c\u8bc1\u7801\uff1a<input type="text" id="fb_vcode" class="b-input" value="" size="6" /><img /></div>').appendTo(l.find(".dcmp_post .dcmp_userinfo")))
            });
            f && (h.find(".fb-vcode-wrp").hide(),
            $(f).find(".fb-vcode-wrp").show());
        ...
        createEmoji: function(G) {
            var F = {
              ...
              , p = {
                ...
                firsrPid: null,
                slider: function(b) {
                    1 == b && (this.current + this.maxShow < this.total ? (this.current += this.maxShow,
                    n.find(".prev").addClass("on"),
                    this.current + this.maxShow >= this.total && n.find(".next").removeClass("on")) : this.current = this.total - this.maxShow);
                    -1 == b && (0 <= this.current - this.maxShow ? (this.current -= this.maxShow,
                    n.find(".next").addClass("on"),
                    0 > this.current - this.maxShow && n.find(".prev").removeClass("on")) : this.current = 0);
                    z.css("left", -this.current * this.tabWidth)
                },
                renderDefault: function() {
                    z.append('<a class="emoji-tab tab-i on" data-pid="emoji"><img src="//static.hdslb.com/images/base/emoji-tab-default.png"></a>');
                    B.html(F.emoji)
                },
                ajaxEmojiRender: function(I) {
                    ...
                    if (I || !I.code || I.data.length) {
                        for (var a = 0; a < I.data.length; a++) {
                            ...
                            h = I.data[a],
                            k = h.emojis,
                            $.isArray(k) && k.length && !h.pstate) {
                                null == p.firsrPid && (p.firsrPid = h.pid);
                                for (var l = 0; l < k.length; l++) {
                                    1 != k[l].state && (b = k[l],
                                    g = (b.name.split("_")[1] || "").slice(0, -1),
                                    H += '<span data-emoji-text="' + b.name + '"><img title="' + g + '" alt="' + b.name + '" data-id="' + b.id + '" data-state="' + b.state + '" data-img="' + utils.thumbnail(b.url, 40) + '"></span>')
                                }
                                F[h.pid] = H;
                                F[h.pid + "_name"] = h.pname || "";
                                $("<a>", {
                                    "class": "emoji-tab tab-i",
                                    "data-pid": h.pid,
                                    html: $("<img>", {
                                        "data-img": utils.thumbnail(h.purl, 22),
                                        alt: h.pname
                                    })
                                }).appendTo(z);
                        ...
                        p.total > p.maxShow && (A.find(".tabs-wrap").append(n),
                        n.on("click", ".prev.on", function() {
                            p.slider(-1)
                        }).on("click", ".next.on", function() {
                            p.slider(1)
                        }));
            ...
            TabModule.bind(z, {
                onChange: function(b) {
                    ...
                    "emoji" != d && (rec_rp("event", "discuss_VIPExpression_show"),
                    rec_rp("event", "discuss_openVIPTittle_show"));
        ...
        createCommentSender: function() {
            if (!this.target.find(".comm_send").length) {
                ...
                $(".ipt-txt", g).bind("keyup", function(b) {
                    ...
                    (m = this.value.match(/@([^\s]*)$/)) ? (k = $(".ipt-txt", g).bilibiliSuggestion(l),
                    $("#textarea_size_tester", g).get(0).innerText = this.value.substr(0, this.value.length - m[1].length)) : k && k.destroy()
                });
        ...
        load: function(F, E, D) {
            function C() {
                if (!d._loaded) {
                    e.addClass("b-load-fail").html("<span>\u52a0\u8f7d\u5931\u8d25\uff0c<a>\u70b9\u51fb\u91cd\u8bd5</a></span>").find("a").on("click", function() {
                        d.load(F, E, D)
                    })
                }
            }
            function n(B, g) {
                var b = d.target;
                if (12002 === B.code) {
                    d._sender.find(".submit-comment").off("click.commentSubmitMsg").addClass("disabled"),
                    d._sender.find(".login-link-wrp").remove(),
                    d._sender.find("#dcmp_textarea_container").addClass("disabled").prepend($('<div class="login-link-wrp">\u672c\u89c6\u9891\u8bc4\u8bba\u529f\u80fd\u5df2\u5173\u95ed</div>')),
                    e.remove()
                } else {
                    if (0 !== B.code || "object" != typeof B.data) {
                        C()
                    } else {
                        $(".common .b-head .results").html(B.data.page.acount).show();
                        E && B.data.page && (d.page = F = B.data.page.num);
                        d._loaded = !0;
                        __GetCookie("bbFrontManager") && UserStatus.isLogin() ? d.isAdmin = 2 : window.mid && window.uid && window.mid == window.uid ? d.isAdmin = 1 : UserStatus.isLogin() && (d.isAdmin = 0);
                        b.children().not(".comm_send").remove();
                        B.data.need_captcha ? (d.needCaptcha = !0,
                        d.createCaptcha(b, B.data.url)) : (d.needCaptcha = !1,
                        d.removeCaptcha());
                        var c = $('<div class="c_order"><ul class="b-slt-tab"><li order="0"><a>\u9ed8\u8ba4\u6392\u5e8f</a></li><li order="2"><a>\u6309\u8d5e\u540c\u6570</a></li><li order="1"><a>\u6309\u56de\u590d\u6570</a></li></ul></div>').prependTo(b);
                        $('li[order="' + d.orderby + '"]', c).addClass("on");
                        $("li", c).click(function() {
                            var p = $(this);
                            p.hasClass("on") || ($("li", c).removeClass("on"),
                            p.addClass("on"),
                            d.orderby = p.attr("order"),
                            d.load(1))
                        });
                        var a = $('<ul class="comm_list"></ul>').appendTo(b)
                          , l = $('<div class="pagelistbox"></div>').appendTo(b)
                          , k = $('<div class="pagelistbox small"></div>').appendTo(c);
                        pagelist(l, F, Math.ceil(B.data.page.count / B.data.page.size), B.data.page.count, function(p) {
                            d.load(p);
                            $(window).scrollTop($(d.target).offset().top + $(".z_top").outerHeight())
                        }, null, 2, !0);
                        "mobile" == d.platform && l.addClass("small");
                        pagelist(k, F, Math.ceil(B.data.page.count / B.data.page.size), B.data.page.count, function(p) {
                            d.load(p)
                        }, null, 2);
                        B.data.replies.length && 0 != B.data.page.acount || $('<div class="no_more">\u6ca1\u6709\u66f4\u591a\u4fe1\u606f</div>').appendTo(a);
                        B.data.top && (B.data.top.content && B.data.page && 1 === B.data.page.num) && (B.data.top.content.message = '<span class="comm-top-stick">\u7f6e\u9876</span>' + B.data.top.content.message,
                        $.isArray(B.data.replies) && B.data.replies.unshift(B.data.top));
                        for (l = 0; l < B.data.replies.length; l++) {
                            "object" == typeof B.data.replies[l] && function(A) {
                                if (A.member && A.content) {
                                    var L = "";
                                    A.member && A.member.official_verify && 0 == A.member.official_verify.type ? L = '<div class="legalize-16-1" style=\'position:absolute;top:50px;left:50px;\' title="\u4e2a\u4eba\u8ba4\u8bc1"></div>' : A.member && (A.member.official_verify && 1 == A.member.official_verify.type) && (L = '<div class="legalize-16-2" style=\'position:absolute;top:50px;left:50px;\' title="\u4f01\u4e1a/\u56e2\u4f53\u8ba4\u8bc1"></div>');
                                    0 === A.root && A.content.message && (A.content.message = A.content.message.replace(/\[[^\[]*]/g, function(M) {
                                        return $("<img>", g[M]).prop("outerHTML") || M
                                    }));
                                    var K = $('<li id="l_id_' + A.rpid + '" class="main-floor"><div class="facebox"><a href="//space.bilibili.com/' + A.member.mid + '" target="_blank" mid="' + A.member.mid + '" card="' + A.member.uname + '"><img src="' + utils.thumbnail(A.member.avatar, 52, 52) + '" class="face"></a><a href="//space.bilibili.com/' + A.member.mid + '" mid="' + A.member.mid + '" target="_blank" class="face_bg" card="' + A.member.uname + '">' + (A.member.pendant && 0 < A.member.pendant.pid ? '<img src="' + utils.thumbnail(A.member.pendant.image, 86) + '" alt="' + A.member.pendant.name + '" />' : "") + L + '</a></div><div class="t"><a href="//space.bilibili.com/' + A.member.mid + '" target="_blank" mid="' + A.member.mid + '" card="' + $("<div/>").text(A.member.uname).html() + '">' + $("<div/>").text(A.member.uname).html() + '</a><a href="//www.bilibili.com/html/help.html#k_3" target="_blank" class="user-info-level l' + (A.member.level_info ? A.member.level_info.current_level : 0) + '"></a>' + (A.member.nameplate && 0 < A.member.nameplate.nid ? '<a href="https://account.bilibili.com/site/nameplate" target="_blank" class="member-nameplate" nameplate-id="' + A.member.nameplate.nid + '"><img src="' + utils.thumbnail(A.member.nameplate.image_small, 32) + '" alt="' + A.member.nameplate.name + '" /></a>' : "") + '</div><div class="content"></div><div class="elinfo"><span class="floor-num">#' + A.floor + "</span>" + (A.content.plat && 1 < A.content.plat ? '<span class="floor-plat">\u6765\u81ea<a href="//app.bilibili.com/" target="_blank">' + ("2" == A.content.plat ? "\u5b89\u5353\u5ba2\u6237\u7aef" : "") + ("3" == A.content.plat ? "iOS\u5ba2\u6237\u7aef" : "") + ("4" == A.content.plat ? "Windows Phone\u5ba2\u6237\u7aef" : "") + "</a></span>" : "") + '<span class="floor-date">' + t(A.ctime) + '</span></span><i class="report"></i></div></li>').appendTo(a);
                                    A.member.vip && (2 == A.member.vip.vipType && 0 != A.member.vip.vipStatus && 2 != A.member.vip.vipStatus) && K.find(".t > a").eq(0).addClass("b-vip-red");
                                    d.pushUser(A.member.mid, K);
                                    L = K.find(".content");
                                    d.recordToObject(L, A);
                                    if (null != A.replies) {
                                        for (var p = $('<div class="reply"><ul class="re_ul"></ul><div class="re_box">' + (5 < A.rcount ? '<p class="re_more"><span>\u8fd8\u6709<b>' + (A.rcount - 5) + '</b>\u6761\u56de\u590d\uff0c</span><a class="re_more_s">\u70b9\u51fb\u67e5\u770b</a></p>' : "") + '<div class="re_page">   <div class="pagelistbox small">   </div></div></div><div class="re_send"></div></div>').appendTo(K), I = $(".re_ul", p), G = 1, L = 0; L < A.replies.length; L++) {
                                            d.reply_render(A.replies[L], A.rpid, I),
                                            E && (A.replies[L].rpid == E && B.data.page.rt_num) && (G = B.data.page.rt_num)
                                        }
                                        $(".re_more_s", p).click(function() {
                                            $(".re_more", p).remove();
                                            d.loadReply($(".pagelistbox", p), I, A.rpid, G)
                                        })
                                    }
                                    var L = K.find(".report"), H, J = $('<a href="javascript:;" class="huifu">\u56de\u590d</a>').appendTo(L).click(function() {
                                        0 == K.find(".reply").length ? (H = $('<div class="reply"><ul class="re_ul"></ul><div class="re_box"><p class="j_re"><a class="re_send_s" href="javascript:;">\u53c2\u4e0e\u56de\u590d</a></p><div class="re_page"> <div class="pagelistbox"></div></div></div><div class="re_send"></div></div>').appendTo(K),
                                        $(".re_box", H).hide(),
                                        $(".re_send_s", H).click(function() {
                                            d.re_send_show(H.find(".re_send"), null, A.rpid)
                                        })) : H = K.find(".reply");
                                        H.find(".re_ul");
                                        d.re_send_show(H.find(".re_send"), null, A.rpid)
                                    });
                                    A.replies && A.replies.length && J.addClass("reply-b").text("\u53c2\u4e0e\u56de\u590d");
                                    0 <= d.isAdmin && ($('<a class="jubao">\u4e3e\u62a5</a>').appendTo(L).click(function() {
                                        return u(this, d.id, d.type, A.rpid)
                                    }),
                                    d.bindAgree($('<a href="javascript:;" class="zan"></a>').prependTo(L), A));
                                    1 == d.isAdmin && (J = $('<a href="javascript:;" title="\u88ab\u9690\u85cf\u540e\uff0c\u5176\u4ed6\u7528\u6237\u4f1a\u9ed8\u8ba4\u4e0d\u663e\u793a\u8be5\u8bc4\u8bba" class="no hidefb">\u9690\u85cf\u8be5\u8bc4\u8bba</a>').appendTo(L).click(function() {
                                        v(this, z, d.type, A.rpid, !0);
                                        return !1
                                    }),
                                    L = $('<a href="javascript:;" class="yes showfb">\u663e\u793a\u8be5\u8bc4\u8bba</a>').appendTo(L).click(function() {
                                        v(this, z, d.type, A.rpid, !1);
                                        return !1
                                    }),
                                    0 == A.state || 6 == A.state || 2 == A.state ? L.hide() : J.hide())
                                }
                            }(B.data.replies[l])
                        }
                        d.checkFeed(d.id);
                        "pc" == d.platform && (bindCardEvent(b),
                        bindNameplateEvent(b));
                        "function" == typeof D && D(b);
                        d.options.useIframe && r();
                        d._trigger("onLoad")
                    }
                }
            }
            ...
            F = this.page;
            var d = this
              , f = 4 == d.type ? 4 : "topic" == d.type ? 2 : 1
              , h = j.base + j.list.getReply + "?jsonp=jsonp&type=" + f + "&sort=" + d.orderby + "&oid=" + d.id + "&pn=" + F + "&r=" + Math.random() + "&nohot=1";
            E && (h = j.base + j.list.getPosition + "?jsonp=jsonp&rpid=" + E + "&type=" + f + "&oid=" + d.id + "&pn=" + F + "&r=" + Math.random() + "&nohot=1");
            this.target.find(".b-loading").remove();
            if (!d._loaded) {
                var e = $('<div class="b-loading"></div>').appendTo(this.target)
            }
            $.when($.ajax({
                dataType: "jsonp",
                url: h
                ...
                if (G && !G.code && G.data.length) {
                    for (var B = 0; B < G.data.length; B++) {
                        var A = G.data[B].emojis;
                        if ($.isArray(A) && A.length) {
                            for (var p = 0; p < A.length; p++) {
                                H[A[p].name] = {
                                    "class": "b-vip-emoji",
                                    title: (A[p].name.split("_")[1] || "").slice(0, -1),
                                    src: utils.thumbnail(A[p].url, 50),
                                    alt: A[p].name
                                }
                            }
                        }
                ...
                onLoginInfoLoaded(function(b) {
                    1 === b.vipStatus && d.emojiXHR.resolve(G)
                }, !0);
                n(l[0], H)
            })
        },
            ...
            if (!this.options.autoLoad || l) {
                ...
                if (this._checkAutoLoad()) {
                    ...
                    $(window).on("scroll.comment-autoload", function() {
                        h._checkAutoLoad() && (h.load(f, l, k),
                        $(window).off("scroll.comment-autoload"))
                    })
                }
            }
        },
...
var CacheManager = {
    ...
    removeItem: function(e, f) {
        if (this.getItem(e)) {
            ...
            0 <= d && (this.getItem(e).splice(d, 1),
            this.reset(e))
        }
    },
    addItem: function(b, d) {
        this.getItem(b) && (this.getItem(b).unshift(d),
        this.reset(b))
    }
};
function attentionUser(e, f, d) {
    ...
    Bilibili.attentionUser(e, f, function(a) {
        -665 == a.code ? $.getScript("//static.hdslb.com/plugins/attentionLimitPopup/attentionLimitPopup.js", function() {
            new attentionLimitPopup
        }) : 0 == a.code ? (window.AttentionList.push(f),
        resetAttentionCache(),
        "undefined" != typeof d && d(a)) : (new MessageBox).show(e, a.msg, 2000, "warning")
    })
}
function unattentionUser(e, f, d) {
    ...
    Bilibili.delFriend(e, f, function(b) {
        if (0 == b.code) {
            var a = window.AttentionList.indexOf(f);
    ...
    _toggle: function(h, l, g, k, j) {
        if (UserStatus.isLogin(l)) {
            ...
            ("bangumi" == h ? $.get("/api_proxy?app=bangumi", {
                ...
                0 == b.code ? (k ? CacheManager.addItem("BangumiFavList", g.toString()) : CacheManager.removeItem("BangumiFavList", g.toString()),
                i._success(l, k, b, j)) : i._fail()
            }) : $.get("/spadmin", {
                action: k ? "attention" : "unfavourite",
                spid: g
            }, function(b) {
                "OK" == b ? (k ? CacheManager.addItem("AttentionList", -g) : CacheManager.removeItem("AttentionList", -g),
                i._success(l, k, b, j)) : i._fail()
            })).fail(function() {
                i._fail()
            })
...
function postJSONLite(b, d) {
    $.browser.msie && 9 >= parseInt($.browser.version) ? (b.data.script = "script",
    b.callback = d,
    postJSON(b)) : $.ajax(b)
}
function postJSON(g) {
...
var UserCard = function() {
    function D(b) {
        F.offset().top > $(window).scrollTop() + 244 ? C.css("top", F.offset().top - 244 + "px") : C.css("top", F.offset().top + 68 + "px");
        F.offset().left + $(".a-layer").outerWidth() > $(window).width() ? C.css("left", F.offset().left - 5 - (F.offset().left + $(".a-layer").outerWidth() - $(window).width()) + "px") : C.css("left", F.offset().left + "px");
    ...
    function A(a) {
        clearTimeout(i);
        E && ($(".a-layer").remove(),
        C = $('<div class="a-layer"><div class="content"><div class="bg_top"></div><div class="msg">' + a + "</div></div></div>").appendTo("body"),
        D())
    }
    function B(d) {
        var c = d.data.card;
        d = d.data.space;
        clearTimeout(i);
        E && "undefined" == typeof c.mid ? A("\u62b1\u6b49\uff0c\u8be5\u6635\u79f0\u76ee\u524d\u4e0d\u5b58\u5728\u54e6(*^__^*)") : (c.top_photo = "//i0.hdslb.com/bfs/static/c9dae917e24b4fc17c4d544caf6b6c0b17f8692b.jpg",
        d && d.s_img && (c.top_photo = d.s_img),
        z(c))
    }
    function z(a) {
        if (E) {
            ...
            var g = ""
              , e = a.sign;
            a.official_verify && (0 == a.official_verify.type ? (g = '<div class="legalize-icon legalize-16-1" style="left:31px;top:126px; position:absolute;z-index:30" title="\u4e2a\u4eba\u8ba4\u8bc1"></div>',
            e = a.official_verify.desc) : 1 == a.official_verify.type && (g = '<div class="legalize-icon legalize-16-2" style="left:31px;top:126px; position:absolute;z-index:30" title="\u4f01\u4e1a/\u56e2\u4f53\u8ba4\u8bc1"></div>',
            e = a.official_verify.desc));
            C = $('<div class="a-layer">' + (a.pendant && a.pendant.image ? '<a href="https://account.bilibili.com/site/face" target="_blank" class="user-pendant"></a>' : "") + '<div class="content main"><div class="user-top-photo" style="background-image:url(' + utils.webp(utils.trimHttp(a.top_photo), {
                h: 120
            ...
            C.find(".layer-follow-btn").html(y(a));
            a.vip && (2 == a.vip.vipType && 0 != a.vip.vipStatus && 2 != a.vip.vipStatus) && C.find("a.user-name").addClass("b-vip-red");
            D(a.pendant)
        } else {
            G[a.name] = a
        }
    ...
    function y(h) {
        var e = !1, p = !1, n, l = function() {
            C.find(".layer-follow-btn").html(y(h))
        };
        ...
        p && e ? (n = $('<a href="javascript:;">\u4e92\u76f8\u5173\u6ce8</a>'),
        n.filter("a").on({
            click: function() {
    ...
    function w() {
        clearTimeout(i);
        A('<span class="loading">\u52a0\u8f7d\u5931\u8d25</span>')
    }
    function v(b, c) {
        F = $(b);
        clearTimeout(i);
        i = setTimeout(w, 5000);
        A('<span class="loading">\u6b63\u5728\u52a0\u8f7d\u4e2d,\u8bf7\u7a0d\u5019..</span>');
        G[c] ? (clearTimeout(i),
        z(G[c])) : $.ajax({
    ...
    function q(b) {
        "undefined" != typeof b ? $(b).find("a[card]").mouseenter(function() {
            $(this).text() && -1 != $(this).text().indexOf("@") || r(this, $(this).attr("mid"))
        }).mouseleave(o) : $("a[card]").mouseenter(function() {
            $(this).text() && -1 != $(this).text().indexOf("@") || r(this, $(this).attr("mid"))
        }).mouseleave(o)
    }
    var j = null, i = null, F = null, C, G = {}, E = !1;
    window.ShowCard = B;
  ...
  , NameplateCard = function() {
    function z() {
        "top" == o.attr("direction") ? q.css("top", o.offset().top - q.outerHeight() + 40 + "px") : q.css("top", o.offset().top + "px");
        o.offset().left + $(".a-layer").outerWidth() + o.width() + 5 > $(window).width() ? q.css("left", o.offset().left - 5 - $(".a-layer").outerWidth() + "px") : q.css("left", o.offset().left + o.width() + 5 + "px");
    ...
    function x(a) {
        A && ($(".a-layer").remove(),
        q = $('<div class="a-layer"><div class="content"><div class="bg_top"></div><div class="msg">' + a + "</div></div></div>").appendTo("body"),
        z())
    }
    function y(a, c) {
        A && "undefined" == typeof a.name ? x("\u62b1\u6b49\uff0c\u8be5\u94ed\u724c\u76ee\u524d\u4e0d\u5b58\u5728\u54e6(*^__^*)") : A ? (j[c] = a,
        $(".a-layer").remove(),
        q = $('<div class="a-layer brand" style="margin-left: 7px;"><div class="arrow"></div><div class="brand_content"><div class="nameplate-image"><img src="' + utils.thumbnail(a.image, 64) + '" alt="' + a.name + '" /></div><div class="nameplate-content"><div class="nameplate-name">' + a.name + '</div><div class="nameplate-condition">' + a.condition + '</div><div class="nameplate-level"><span>' + a.level + '</span><a href="https://account.bilibili.com/site/nameplate" target="_blank">\u67e5\u770b\u5168\u90e8&gt;</a></div></div></div></div></div>').appendTo("body"),
        z()) : j[c] = a
    }
    function w(b, c) {
        o = $(b);
        x('<span class="loading">\u6b63\u5728\u52a0\u8f7d\u4e2d,\u8bf7\u7a0d\u5019..</span>');
        j[c] ? y(j[c], c) : i = $.ajax({
            ...
            success: function(d) {
                d && 0 == d.code && d.data ? y(d.data, c) : x('<span class="loading">\u52a0\u8f7d\u5931\u8d25</span>')
            },
            error: function() {
                x('<span class="loading">\u52a0\u8f7d\u5931\u8d25</span>')
            }
        })
    }
    function v(d, c) {
    ...
    function s(b) {
        "undefined" != typeof b ? $(b).find("a[nameplate-id]").mouseenter(function() {
            v(this, $(this).attr("nameplate-id"))
        }).mouseleave(u) : $("a[nameplate-id]").mouseenter(function() {
            v(this, $(this).attr("nameplate-id"))
        }).mouseleave(u)
    }
    var r = null, o = null, q, j = {}, i = null, A = !1;
    window.ShowNameplate = y;
    window.bindNameplateEvent = s;
    return {
        show: y,
        bind: s
    }
...
function bindPOCoins2(w, u) {
    ...
    w.each(function(b, l) {
        ...
        if (v(k, "gk") || k.attr("data-view")) {
            if ($(l).parents(".rlist").length && k.hover(i, o),
            "undefined" === typeof u || !1 !== u) {
                c = parseInt(v(k, "yb")),
...
function onLoginInfoLoaded(b, d) {
    "undefined" != typeof window.biliLoginStatus ? (b(window.biliLoginStatus),
    !0 === d && window.loginCallbacks.push(b)) : window.loginCallbacks.push(b)
}
var UserStatus = function() {
    return {
        ...
        quickLogin: function(b, d) {
            1 == arguments.length && "object" == typeof b && (d = b,
            b = null);
            d && d.preventDefault();
...
function loadLoginInfo(f, h) {
    ...
    for (e = 0; e < loginCallbacks.length; e++) {
        loginCallbacks[e](f),
        f.isLogin && (loginCallbacks.splice(e, 1),
        e--)
    }
}
function onLoginNavigator(h) {
    if ($(".z_top").length) {
        if (h.isLogin) {
            ...
            h.vipType && 0 != h.vipStatus && (2 == h.vipType && 2 != h.vipStatus && $(".uname > b", g).addClass("b-vip-red"),
            l[h.vipType] && 2 != h.vipStatus && $(".uname", g).append('<div class="layer-row"><a href="//big.bilibili.com/site/big.html" target="_blank"><span class="vip-hinter" data-vip-type="' + h.vipType + '">' + l[h.vipType] + "</span></a></div>"));
            l = "top:65px;right:-16px;";
            h.pendant && h.pendant.image && (l = "top:52px;right:-6px;");
            var k = "";
            1 != h.vipType && 2 != h.vipType || 1 != h.vipStatus ? $("#i_menu_become_vip a").hide() : ($("#i_menu_become_vip a").text("\u5927\u4f1a\u5458"),
            $.ajax({
            ...
            h.level_info && 0 < h.level_info.current_level && 1 <= h.money ? (l = String(h.money).split("."),
            l = 2 === l.length ? (h.money - 1).toFixed(l[1].length) : h.money - 1,
            $(".coin", g).html('<b class="b-back"></b><b class="b-icon"></b><div class="outside"><div class="pre">' + l + '</div><div class="cur" title="' + h.money + '">' + utils.formatNum(h.money) + '<span class="reward-for-login">&nbsp;\u767b\u5f55\u5956\u52b1</span></div></div>')) : $(".coin", g).html('<b class="b-icon"></b>' + h.money);
...
function profileWnd(B) {
    var y = $("#i_menu_profile_btn")
      , z = $("#i_menu_profile")
      , w = y.find(".i_face")
      , v = z.find(".info").addClass("clearfix")
      , u = z.find(".coin");
    if (y.length) {
        z.find(".member-menu .notice").parents(".member-menu").remove();
        z.find(".member-menu a").attr("target", "_blank");
        if (0 == B.email_verified && 0 == B.mobile_verified) {
            var s = $('<a class="phone" href="https://passport.bilibili.com/member/bindphone.html" target="_blank"></a>').attr({
                tips: "\u524d\u53bb\u7ed1\u5b9a\u624b\u673a",
                "tips-pos": "l"
            })
              , r = $('<a class="email" href="https://passport.bilibili.com/member/bindmail.html" target="_blank"></a>').attr({
                tips: "\u524d\u53bb\u7ed1\u5b9a\u90ae\u7bb1",
                "tips-pos": "l"
            })
        } else {
            1 == B.email_verified && 0 == B.mobile_verified ? (s = $('<a class="phone" href="https://passport.bilibili.com/member/hasmailcheckmail.html" target="_blank"></a>').attr({
                tips: "\u524d\u53bb\u7ed1\u5b9a\u624b\u673a",
                "tips-pos": "l"
            }),
            r = $('<a class="email verified" href="https://account.bilibili.com/" target="_blank"></a>').attr({
                tips: "\u5df2\u7ed1\u5b9a",
                "tips-pos": "l"
            })) : 0 == B.email_verified && 1 == B.mobile_verified ? (s = $('<a class="phone verified" href="https://account.bilibili.com/" target="_blank"></a>').attr({
                tips: "\u5df2\u7ed1\u5b9a",
                "tips-pos": "l"
            }),
            r = $('<a class="email" href="https://passport.bilibili.com/member/hasphonecheckphone.html" target="_blank"></a>').attr({
                tips: "\u524d\u53bb\u7ed1\u5b9a\u90ae\u7bb1",
                "tips-pos": "l"
            })) : 1 == B.email_verified && 1 == B.mobile_verified && (s = $('<a class="phone verified" href="https://account.bilibili.com/" target="_blank"></a>').attr({
                tips: "\u5df2\u7ed1\u5b9a",
                "tips-pos": "l"
            }),
            r = $('<a class="email verified" href="https://account.bilibili.com/" target="_blank"></a>').attr({
        ...
        v.find(".phone, .email").remove();
        v.append(s).append(r);
        v.find(".coin").attr("title", "\u786c\u5e01");
        z.find(".coin").parent().is("a") || z.find(".coin").wrap('<a href="https://account.bilibili.com/site/coin" target="_blank"></a>');
        B.pendant && B.pendant.image ? ($("<img>", {
            "class": "i_face-pendant hide",
            src: utils.trimHttp(B.pendant.image),
            alt: B.pendant.name
        }).insertAfter(w),
        w.addClass("has_pendant")) : w.removeClass("has_pendant");
        ...
        hoverDelay(y, function() {
            ...
            z.is(":visible") || (w.addClass("scale-in"),
            b[c] == q() && u.removeClass("hover-first").addClass("hover-again"),
            z.stop().slideDown(200, function() {
                o.removeClass("hide");
                $(".legalize-icon", y).show();
                b[c] != q() && B.mobile_verified && (b[c] = q(),
                utils.localStorage.setItem("time_tracker", JSON.stringify(b)),
                $("#i_menu_profile .info a.linkToCurrency").addClass("off"),
                setTimeout(function() {
                    $("#i_menu_profile .info a.linkToCurrency").removeClass("off").addClass("on")
                }, 3000),
                u.removeClass("hover-again").addClass("hover-first"))
            }))
        }, function() {
            o.addClass("hide");
            $(".legalize-icon", y).hide();
            z.stop().slideUp(200, function() {
                u.removeClass("hover-first hover-again")
            });
            w.removeClass("scale-in")
        });
        ToolTips.bind(z, 5, !1, "nav-tool-tip");
        z.find(".user-info").remove();
        var j = null;
        ...
        s = B.level_info;
        r = $('<a class="help-link" href="//www.bilibili.com/html/help.html#k" target="_blank">\u4f1a\u5458\u7b49\u7ea7\u76f8\u5173\u8bf4\u660e ></a>');
        i = $('<div class="user-info" id="lv_info"><div class="user-info-hd"><span class="t">\u7b49\u7ea7</span></div><div class="points-wrp" id="exp_wrp"><a href="https://account.bilibili.com/site/record?type=exp" target="_blank"><div class="points-cnt"><div class="lt"></div><div class="fill-el"></div><div class="bar"><div class="points"></div></div><div class="points-schedule"><span class="now-points">' + s.current_exp + '</span><span class="next-points">/' + s.next_exp + "</span></div></div></a></div></div>").addClass("l" + s.current_level).insertAfter(z.find(".info"));
        var C = i.find("#exp_wrp");
        0 == s.current_level && i.find(".points-schedule").html('<a class="lv-0" href="https://account.bilibili.com/answer/base" target="_blank">\u7b54\u9898\u8f6c\u6b63\u76f4\u5347Lv' + (s.after_answer || 2) + "</a>");
        var A = $('<div class="user-info-desc"><span class="arrow-left"></span><div class="lv-row">\u4f5c\u4e3a<strong>LV' + s.current_level + "</strong>" + (0 == s.current_level ? "\uff0c\u4f60\u65e0\u6cd5\u4eab\u53d7\u7279\u6743" : "\uff0c\u4f60\u53ef\u4ee5\uff1a") + "</div><div>" + "\u6210\u4e3a\u6b63\u5f0f\u4f1a\u5458\uff0c\u4f60\u53ef\u4ee5\uff1a<br/>1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u8bc4\u8bba<br/>3\u3001\u767b\u5f55\u83b7\u5f97\u786c\u5e01<br/>4\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u53d1\u5c04\u6eda\u52a8\u5f39\u5e55<br/>2\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\uff09<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\uff09<br/>3\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>3\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>3\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u8d2d\u4e70\u9080\u8bf7\u7801\uff081\u4e2a/\u6708\uff09<br/>2\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>3\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>4\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u8d2d\u4e70\u9080\u8bf7\u7801\uff082\u4e2a/\u6708\uff09<br/>2\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>3\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>4\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf".split(" ")[s.current_level] + "</div></div>").hide().appendTo(C);
        i.mouseenter(function(b) {
            clearTimeout(j);
            A.stop(!0, !0).fadeIn(200)
        }).mouseleave(function(b) {
            j = setTimeout(function() {
                A.stop(!0, !0).fadeOut(200)
            }, 300)
        });
        i.find(".user-info-desc").append(r);
        6 == s.current_level ? i.find(".points").css("width", "100%") : i.find(".points").css("width", (100 * (s.current_exp / s.next_exp) >> 0) + "%");
        0 == B.email_verified && 0 == B.mobile_verified ? v.after("<div class='link-to-bind-mobile'> <a style='' target='_blank' href=' https://passport.bilibili.com/member/bindphone.html'>\u7ed1\u5b9a\u624b\u673a\u53ef\u9886\u53d6\u6bcf\u65e5\u786c\u5e01</a> </div>") : 1 == B.email_verified && 0 == B.mobile_verified && v.after("<div class='link-to-bind-mobile'> <a style='' target='_blank' href=' https://passport.bilibili.com/member/hasmailcheckmail.html'>\u7ed1\u5b9a\u624b\u673a\u53ef\u9886\u53d6\u6bcf\u65e5\u786c\u5e01</a> </div>")
    }
}
window.dynObjects = {};
...
function initDynWnd(j) {
    ...
    if (0 != i.length) {
        ...
        j = {
            ...
            append: function(D) {
                var C = ""
                  ...
                  , E = ""
                  , t = "";
                if (utils.isBeta([0, 1, 2, 3, 4])) {
                    var s = D.archive || D.bangumi;
                    switch (D.type) {
                    case 0:
                        D.official_verify && 0 == D.official_verify.type ? t = '<div class="legalize-14-1" style=\'vertical-align:top;margin-top:2px\' title="\u4e2a\u4eba\u8ba4\u8bc1" ></div>' : D.official_verify && 1 == D.official_verify.type && (t = '<div class="legalize-14-2" style=\'vertical-align:top;margin-top:2px\' title="\u4f01\u4e1a/\u56e2\u4f53\u8ba4\u8bc1"></div>');
                        C = utils.trimHttp(s.pic);
                        B = s.owner && s.owner.name;
                        u = 'card="' + s.author + '" mid="' + (s.owner && s.owner.mid) + '"';
                        A = "<span>\u6295\u7a3f\u4e86</span>";
                        z = s.title;
                        y = "//space.bilibili.com/" + (s.owner && s.owner.mid);
                        x = "//www.bilibili.com/av" + s.aid;
                        E = " v";
                        break;
                    case 1:
                        z = 10 <= (s.new_ep && s.new_ep.index) ? "" : "0";
                        C = utils.trimHttp(s.cover);
                        B = s.title;
                        A = "<span>\u66f4\u65b0\u4e86</span>";
                        F = '<span class="sp">\u756a\u5267</span>';
                        z = s.title + " " + z + (s.new_ep && s.new_ep.index) + " " + (s.new_ep && s.new_ep.index_title) + (s.is_finish ? " \u3010\u5b8c\u7ed3\u3011" : "");
                        y = "//bangumi.bilibili.com/anime/" + s.season_id + "/";
                        x = "//bangumi.bilibili.com/anime/" + s.season_id + "/play#" + s.new_ep.episode_id;
                        break;
                    case 5:
                        ...
                        z = s.title;
                        y = "//bilibili.com/sp/" + B;
                        x = utils.trimHttp(s.link);
                        break;
                    case 6:
                        C = utils.trimHttp(D.source.avatar),
                        B = D.source.uname,
                        u = 'card="' + D.source.uname + '" mid="' + D.source.mid + '"',
                        A = "<span>\u53d1\u8868\u4e86\u8bc4\u8bba</span>",
                        z = D.content.msg,
                        y = "//space.bilibili.com/" + D.source.mid,
                        x = utils.trimHttp(s.link + D.content.flink),
                        E = " u"
                    }
                } else {
                    switch (s = D.addition,
                    D.type) {
                    case 1:
                        D.source && D.source.official_verify && 0 == D.source.official_verify.type ? t = '<div class="legalize-14-1" style=\'vertical-align:top;margin-top:2px\' title="\u4e2a\u4eba\u8ba4\u8bc1" ></div>' : D.source && (D.source.official_verify && 1 == D.source.official_verify.type) && (t = '<div class="legalize-14-2" style=\'vertical-align:top;margin-top:2px\' title="\u4f01\u4e1a/\u56e2\u4f53\u8ba4\u8bc1"></div>');
                        C = utils.trimHttp(s.pic);
                        B = s.author;
                        u = 'card="' + s.author + '" mid="' + s.mid + '"';
                        A = "<span>\u6295\u7a3f\u4e86</span>";
                        z = s.title;
                        y = "//space.bilibili.com/" + s.mid;
                        x = utils.trimHttp(s.link);
                        E = " v";
                        break;
                    case 3:
                        ...
                        F = '<span class="sp">\u756a\u5267</span>';
                        z = s.title;
                        y = "//bangumi.bilibili.com/anime/" + D.source.season_id + "/";
                        x = utils.trimHttp(s.link);
                        break;
                    case 5:
                        C = utils.trimHttp(D.source.cover);
                ...
                return $('<li class="d-data"><div class="preview' + E + '"><img src="' + utils.trimHttp(C) + '" /></div><div class="r"><div class="title">' + (F ? F : "") + t + '<a href="' + y + '"' + ("" != u ? u : "") + ' target="_blank">' + B + "</a>" + A + '</div><div class="info"><a href="' + x + '" target="_blank" title="' + (6 != D.type ? z : s.title) + '">' + z + "</a></div></div></li>")
            },
            onData: function(d) {
                var c = CacheManager.getItem("biliLoginStatus").dynamic;
                c && (c.all = 0,
                CacheManager.reset("biliLoginStatus"));
                return utils.isBeta([0, 1, 2, 3, 4]) ? d.data : d.data.feeds
            },
            total: p,
            history: !0
        };
        ...
        $.ajax({
            url: utils.isBeta([0, 1, 2, 3, 4]) ? "//api.bilibili.com/x/web-feed/feed/unread" : "//api.bilibili.com/x/feed/unread/count",
            data: {
                jsonp: "jsonp"
            },
            dataType: "jsonp",
            ...
            success: function(e) {
                ...
                e = e.data && (utils.isBeta([0, 1, 2, 3, 4]) ? e.data.count : e.data.all);
...
MiniWnd.prototype = {
    init: function(e, f) {
        var d = this;
        e = $(e);
        e.length && ("object" != typeof f.wnd && (f.wnd = $(f.wnd)),
        f.wnd.appendTo(e),
        d.setPos(e, f.wnd),
        "undefined" == typeof f.timer && (f.timer = null),
        e.hover(function() {
            d.show(f)
        }, function() {
            d.hide(f)
...
function initMiniWnd() {
    function K(k, h) {
        if (h.biliHistoryData) {
            ...
            for (var t = [], s = [], p = [], n = 0; n < k.length; n++) {
                t.push(k[n].aid)
            }
            for (n = 0; n < t.length; n++) {
                var l = s.indexOf(t[n]);
                -1 == l ? s.push(t[n]) : (s.splice(l, 1),
                s.push(t[n]),
                p.splice(l, 1));
                p.push(k[n])
            }
            n = 0;
            for (t = p.length; n < t; n++) {
                s = 0 === t % 2 ? s = t / 2 : Math.ceil(t / 2),
                n < s && (s = p[n],
                p[n] = p[t - 1 - n],
                p[t - 1 - n] = s)
            }
    ...
    function I(l, h) {
        ...
        var f = h.data;
        J(new Date);
        var e = !1, Q = !1, P = !1, L = !1, N = !1, O;
        for (O in f) {
            if ("object" == typeof f[O]) {
                var M = 1000 * f[O].view_at
                  , k = $('<li class="timeline"><span class="date"></span></li>');
                G(M) && !e ? (k.find(".date").html("\u4eca\u65e5"),
                k.appendTo(g),
                e = !0) : F(M) && !Q ? (k.find(".date").html("\u6628\u65e5"),
                k.appendTo(g),
                Q = !0) : E(M) && !P ? (k.find(".date").html("\u8fd11\u5468"),
                k.appendTo(g),
                P = !0) : D(M) && !L ? (k.find(".date").html("1\u5468\u524d"),
                k.appendTo(g),
                L = !0) : B(M) && !N ? (k.find(".date").html("1\u4e2a\u6708\u524d"),
                k.appendTo(g),
                N = !0) : G(M) || (F(M) || E(M) || D(M) || B(M)) || (k.find(".date").html((new Date(1000 * f[O].view_at)).format("yyyy-MM-dd hh:mm:ss")),
                k.appendTo(g));
                if (null != f[O].title) {
                    var b = $('<li><a  class="item-a" href="' + C + "/video/av" + f[O].aid + '" target="_blank" title="' + f[O].title + '" data-aid="' + f[O].aid + '">' + f[O].title + "</a></li>")
                }
                b.appendTo(g)
            }
        }
        0 == g.children().length && (g.addClass("empty"),
        $('<li class="no-data">\u6ca1\u6709\u6570\u636e\u54e6\uff0c\u591a\u770b\u70b9\u89c6\u9891\u5427</li>').appendTo(g))
    }
    function J(b) {
        return {
            year: b.getFullYear(),
    ...
    function F(b) {
        var d = J(new Date);
        b = J(new Date(b + 86400000));
        return H(b, d)
    }
    function E(b) {
        for (var l = !1, k = J(new Date), h = 2; 8 > h; h++) {
            var d = J(new Date(b + 86400000 * h));
            if (H(d, k)) {
                l = !0;
                break
            }
    ...
    function D(b) {
        for (var l = !1, k = J(new Date), h = 8; 31 > h; h++) {
            var d = J(new Date(b + 86400000 * h));
            if (H(d, k)) {
                l = !0;
                break
    ...
    function B(b) {
        for (var l = !1, k = J(new Date), h = 31; 91 > h; h++) {
            var d = J(new Date(b + 86400000 * h));
            if (H(d, k)) {
                l = !0;
                break
    ...
    var C = "//www.bilibili.com"
      , A = $("#i_menu_fav_btn")
      , z = $("#i_menu_history_btn")
      , r = new MiniWnd;
    if (A.length && UserStatus.status().isLogin) {
        var i = {
            ...
            render: function(g, f) {
                ...
                l.empty();
                for (var h in k) {
                    "object" == typeof k[h] && (null != k[h].title ? $('<li><a href="' + C + "/video/av" + k[h].aid + '" target="_blank" title="' + k[h].title + '">' + k[h].title + "</a></li>") : $('<li><a href="' + C + "/mylist" + k[h].lid + '" target="_blank" title="' + k[h].description + '">' + k[h].description + "</a></li>")).appendTo(l)
                }
    ...
    if (z.length) {
        if (UserStatus.status().isLogin) {
            ...
            if ("www.bilibili.com" !== location.host) {
                var o = $('iframe[src="//www.bilibili.com/html/iframemessage.html"]')[0];
                o || "bilibili" != document.domain.split(".")[1] || (document.domain = "bilibili.com",
                o = document.createElement("iframe"),
                o.style.cssText = "position:absolute;width:1px;height:1px;left:-9999px;",
                o.src = "//www.bilibili.com/html/iframemessage.html",
                document.body.appendChild(o),
                $(o).load(function() {
                    q = o.contentWindow.localStorage;
                    y = K(y, q);
                    var a = {
                        wnd: $('<div class="mini-wnd"><div class="top-login"><p class="txt">\u767b\u5f55\u540e\u6709\u66f4\u591a\u529f\u80fd\u54e6\uff5e</p><a class="loginbtn" href="https://passport.bilibili.com/login">\u767b\u5f55</a></div><ul class="list history"></ul><a class="read-more" href="//www.bilibili.com/account/history">\u67e5\u770b\u66f4\u591a<i class="b-icon b-icon-arrow-r"></i></a></div>'),
                        data: {
                            data: y
                        },
                        render: function(d, c) {
    ...
    z.find(".i-link").on("click", function(b) {
        b.preventDefault();
        rec_rp("event", "nav_righttoolbar_history_click");
        window.open("//www.bilibili.com/account/history")
    });
    j.find(".openbtn").on("click", function(b) {
        b.preventDefault();
        window.open("//www.bilibili.com/account/history")
    });
    j.siblings(".read-more").on("click", function(b) {
        b.preventDefault();
        rec_rp("event", "nav_righttoolbar_history_more_click");
        window.open("//www.bilibili.com/account/history")
    });
    j.siblings(".list").on("click", function(b) {
        b.preventDefault();
        b = $(b.target) || $(b.srcElement);
        b.hasClass("item-a") && (rec_rp("event", "nav_righttoolbar_history_tovideoplaypage"),
        window.open(C + "/video/av" + b.data("aid")))
    });
    j.length && $.ajax({
...
function initLiveDyn() {
    ...
    $.get(q + "feed/count", function(d) {
        ...
        0 == d.code && d.data.count && ($("#live_num").show(),
        $("#dynamic_num_total").html(c).show())
    }, "jsonp")
}
function dynManage(b) {
    ...
    this.tryTime = 0;
    this.TRY_MAX = 3;
    this.apiUrl = utils.isBeta([0, 1, 2, 3, 4]) ? utils.protocolRelative(b.apiUrl || "//api.bilibili.com/x/web-feed/feed") : utils.protocolRelative(b.apiUrl || "//api.bilibili.com/x/feed/pull");
    this.bindScroll()
}
dynManage.prototype = {
    bindScroll: function() {
        ...
        $.ajax({
            ...
            success: function(j) {
                if (0 == j.code) {
                    ...
                    b.setLoading(0);
                    j = utils.isBeta([0, 1, 2, 3, 4]) ? 0 == b.getResults(j) : b.num >= b.getResults(j);
    ...
    getResults: function(b) {
        return utils.isBeta([0, 1, 2, 3, 4]) ? b.data.length : b.data.page.count
    },
        ...
        xhrParams: function() {
            ...
            return {
                ...
                success: function(a) {
                    ...
                    g.page >= a.numPages ? (c.state.find("> .loading-spinner").hide(),
                    c.noDataPrompt ? c.state.find("> b").html(c.noDataPrompt) : c.state.hide()) : (c.state.show(),
                    c.state.find("> .loading-spinner").show(),
                    c.state.find("> b").html("\u67e5\u770b\u66f4\u591a..."),
                    setTimeout(function() {
                        0 != $(c.target).height() && g.scroll()
                    }, 0));
                    0 != g.page % c.showPageAfter && 1 !== c.showPageAfter || g.manualLoad ? $(c.pageContainer).hide() : (g.waitManualOperate = !0,
                    c.state.hide());
                    (0 == g.page % c.showPageAfter || g.page >= a.numPages || 1 === c.showPageAfter) && 1 < g.showPages && ($(c.pageContainer).show(),
                    g.showPage())
                }
            }
        }
...
function biliShowFloatAds(E, B, C, A, z, y, w, r) {
    try {
        var o = (new Date).getSeconds() % C.length
          , q = C[o];
        if ("banner" == E) {
            if (0 < $(".header .logo").length) {
                var j = $(".header .logo")
                  , i = $('<div class="bili_live_pmt" b-stat="float-pmt-banner" b-stat-v="' + q[1] + '"><a href="' + q[1] + '" target="_blank"></a></div>').css({
                    width: z || 150,
                    height: y || 80,
                    "margin-top": -20,
                    background: "url(" + utils.trimHttp(q[0]) + ") no-repeat",
                    left: j.position().left + j.outerWidth() + 30
        ...
        var H = ChatGetSettings("bili-float-ads-close");
        if (!($("#a_ds_" + B).length || H && parseInt(H.split(",")[0]) == B && H.split(",")[1] && (new Date).getTime() < parseInt(H.split(",")[1]))) {
            E = z || 150;
            var D = y || 80
              , I = $(".z");
            if (I.length) {
                var G = $("<a>").addClass("float-pmt").attr({
                    id: "a_ds_" + B,
                    href: q[1],
                    target: "_blank",
                    "b-stat": "float-pmt",
                    ...
                    position: "absolute",
                    right: -E,
                    top: $(window).scrollTop() + $(window).height() - I.offset().top - D - 220,
                    height: D,
                    width: E,
                    "z-index": 10050
                });
                $("<img />").attr("src", utils.trimHttp(q[0])).css({
                    width: "100%",
                    height: "100%",
                    display: "block"
                }).appendTo(G);
                $("<div>\u00d7</div>").css({
                    ...
                    "border-radius": "4px",
                    color: "#222"
                }).appendTo(G).on("click", function(b) {
                    b.preventDefault();
                    b.stopPropagation();
                    G.remove();
                    A = A || 0;
                    ChatSaveSettings("bili-float-ads-close", B + "," + ((new Date).getTime() + 3600000 * A))
                });
                G.appendTo(I);
                $(window).on("scroll.bili-float-ads", function() {
                    G.css("top", $(window).scrollTop() + $(window).height() - I.offset().top - D - 220)
                });
                return G
            }
        }
...
function biliShowAds(w, u, v, t, s) {
    ...
    try {
        var q = ""
          , p = "";
        $.isPlainObject(this) && (q = this.id ? this.id : "",
        p = this.loc_id ? this.loc_id : "");
        ...
        "i" == o[0] ? $('<a id="a_ds_' + u + '" data-id="' + q + '" data-loc-id="' + p + '" href="' + o[3] + '" target="_blank"><img src="' + utils.trimHttp(v ? o[2] : o[1]) + '"' + s + ' border="0" /></a>').appendTo(t) : $('<embed id="a_ds_' + u + '" wmode="opaque" pluginspage="//www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" allowscriptaccess="none" rel="noreferrer" src="' + (v ? o[2] : o[1]) + '"' + s + ' type="application/x-shockwave-flash" allowfullscreen="true" quality="high">').appendTo(t);
        $(t).show()
    } catch (i) {}
}
...
function _bili_crossdomain(i, o) {
    ...
    for (l in i) {
        ...
        "" == k && !1 === i[l] || (k == i[l] || encodeURIComponent(k) == i[l]) || (h[l] = k,
        n = !0)
    }
    if (n) {
        var n = "//interface.bilibili.com/crossdomain_cookie.do?callback=?", j;
        for (j in h) {
...
function biliCachedJSON(i, o, h, n, l) {
    ...
    if (window.sessionStorage) {
        try {
            ...
            ,
            void 0 === (k = window.sessionStorage[o]) ? $.ajax(i) : (k = JSON.parse(k),
...
var SelectModule = function() {
    function b(c, e) {
        ...
        if ("undefined" != typeof c && ("string" == typeof c || c instanceof $ ? (this.obj = $(c),
        this.params = e || {}) : (this.params = c,
  ...
  , TabModule = function() {
    function b(f, c, h) {
        if ("undefined" != typeof f && ("string" == typeof f || f instanceof $ ? (this.obj = $(f),
        this.params = c || {}) : (this.params = f,
        this.obj = $(this.params.item)),
        this.obj.length)) {
            var g = this;
...
IndexNavigator.prototype = {
    ...
    Cantor: {
        ...
        encode: function(h) {
            var l, g, k = h.length, j = this.create(), i = [];
            for (l = 0; l < k; l++) {
                for (g = i[l] = 0; g < l; g++) {
                    h[g] > h[l] && i[g]++
                }
    ...
    init: function() {
        ...
        for (e = 0; e < this.config.nav.length; e++) {
            if (f = this.config.nav[e].id,
            !this.config.block || this.config.block[f]) {
    ...
    createNavigator: function() {
        ...
        if (this._isIndex || this.config.appIcon) {
            var f = $('<div class="n-i n-i-mlink"><a href="//app.bilibili.com/?channel=home_recommend" target="_blank"><div class="mlink-dl-msg"></div><div class="n-i-mlink-bg"></div></a></div>').insertAfter(g), i = new Animator({
    ...
    setNavConfig: function(j) {
        ...
        if ("undefined" != typeof j.sort) {
            ...
            for (var k in o) {
                "function" !== typeof o[k] && (l.push(parseInt(k)),
                this.seq.push(o[k]),
                p.push(i[k]))
            }
            l = $.map(l, function(b) {
            ...
            parseInt(j.len) != this.configMap.length && (j.len = this.configMap.length,
            j.sort = this.Cantor.encode(l).toString(32),
            this.uploadSetting(j),
            this.saveSetting(j));
            this.config.nav = p
        } else {
    ...
    sort: function(e, f) {
        ...
        for (var d = 0; d < e.length; d++) {
            void 0 !== e[d] && (this.seq.push(this.configMap[e[d]]),
            f && f(d))
        }
    },
    showTip: function() {
    ...
    bindClick: function(e, f) {
        ...
        e.click(function() {
            var b = $(f);
            d.customizing && d.isMobile || !b.length || (d.scrolling = 1,
            $("html,body").animate({
    ...
    follow: function() {
        for (var g = $(window), j = -1, f = 0; f < this.navItems.length; f++) {
            ...
            if (h.length && (g.scrollTop() + g.height() / 2 > h.offset().top && (g.scrollTop() < h.offset().top + h.height() / 2 || this.navItems[f + 1] && $(this.navItems[f + 1].target).offset().top > g.scrollTop() + g.height() / 2)) && (this.nav.find(".n-i").removeClass("on"),
        ...
        -1 == j && (this.nav.find(".n-i").removeClass("on"),
    ...
    initCustomize: function() {
        function j() {
            ...
            i.customizing = 0;
            $("body").off("click", j);
            "undefined" == typeof l.sort || "undefined" != typeof i.userSettings.sort && l.sort == i.userSettings.sort || (l.len = i.configMap.length,
            i.uploadSetting(l),
            i.saveSetting(l))
        }
        function q(b, h) {
            ...
            k.on("click", function() {
                if (i.customizing) {
                    ...
                    c.find(".prev").on("click", function(a) {
                        a.stopPropagation();
                        var e = b.prev();
                        e.length && e.hasClass("sortable") && (b.insertBefore(b.prev()),
                        q(a, b))
                    });
                    c.find(".next").on("click", function(a) {
                        a.stopPropagation();
                        var e = b.next();
                        e.length && e.hasClass("sortable") && (b.insertAfter(b.next()),
                        q(a, b))
                    })
                }
            })
        ...
        i.customContainer.click(function(a) {
            a.stopPropagation();
            i.customizing ? j() : (i.pointer.hide(),
            o.is(":visible") || o.appendTo("body").stop().hide().fadeIn(),
            "undefined" != typeof i.tipWnd && i.tipWnd.fadeOut(200, function() {
                i.tipWnd.remove()
            }),
            n.prependTo(i.nav).show(),
            p.prependTo(i.nav).show(),
            i.nav.removeClass("focus").addClass("customizing"),
            i.nav.find(".on").removeClass("on"),
            i.customModuleInitialized ? i.nav.sortable("enable") : (i.nav.sortable({
                items: ".sortable",
...
var LazyImage = function() {
    ...
    b.prototype.show = function() {
        for (var e = 0; e < this.covers.length; e++) {
            var c = this.covers[e]
              , f = c.element
              , c = c.callback;
            f.attr("loaded") || ("wrap" != this.config.mode || f.parent(".img-loading").length ? "wrap" != this.config.mode && f.attr("src", utils.trimHttp(this.config.defaultImg)) : (f.attr("src", "//static.hdslb.com/images/transparent.gif"),
            f.wrap(this.wrapper).parent().css({
                background: "#f5f5f5 url(//static.hdslb.com/images/v3images/img_loading.png) center center no-repeat",
                height: "100%"
            })),
            this._inViewRange(f) && (this.load(f, c),
    ...
    b.prototype.load = function(u, t) {
        ...
        var r = this, q = $("<img />"), p = utils.trimHttp(LoadWebp.setSrc(u.attr("data-img"))), o = new Date, i = 0, j = o.getTime(), c;
        q.on("load", function() {
            var a = new Date;
            c = a.getTime() - j;
            r.list.push(c);
            ...
            u.attr("data-alt") && (u.attr("alt", u.attr("data-alt")),
            u.removeAttr("data-alt"));
        ...
        q.on("error", function() {
            0 <= r.list.indexOf(p) ? "" : r.list.push(-1);
            20 <= r.list.length && s();
            clearTimeout(r.shuttle);
            r.shuttle = setTimeout(function() {
                s()
        ...
        q.attr("src", p);
        u.attr("alt") && (u.attr("data-alt", u.attr("alt")),
        u.removeAttr("alt"));
        u.attr("loaded", "loaded");
        q.error(function() {
            i++;
            2 >= i ? q.attr("src", p) : r.unwrap(u)
        })
    }
    ;
...
SliderController.prototype = {
    ...
    init: function() {
        ...
        d.dataSrc && (0 == $(d.parent).find(".p-loading").length && this.loading.appendTo(this.wrapper),
        "function" == typeof d.dataSrc ? $.getJSON(d.dataSrc(), function(a) {
            b.loading.remove();
            b.load(a)
        }) : "string" == typeof d.dataSrc ? $.getJSON(d.dataSrc, function(a) {
            b.loading.remove();
            b.load(a)
        }) : "object" == typeof d.dataSrc && (this.loading.remove(),
        this.load(d.dataSrc)))
    },
    load: function(f) {
        var h = this.params, e;
    ...
    add: function(i, o) {
        ...
        var j;
        "function" == typeof h.item ? j = h.item(i, k) : (j = $(h.item),
        $("img", j).attr("src", utils.trimHttp(i.img)),
    ...
    _onMessage: function(e) {
        if (7 == parseInt("0x" + e.data.substr(0, 4))) {
            try {
                ...
                this._notifyHandlers[f.index] && (this._log("call func:", f),
                this._notifyHandlers[f.index](f.index, f.payload))
            } catch (d) {}
        }
    },
    _onError: function(b) {},
...
var RequireModule = function() {
    ...
    return {
        ...
        getScript: function(c, b, a) {
            ...
            b = g + (e[c] || f(c, c))) : 1 == arguments.length && (b = g + (e[c] || f(c, c)));
            window[c] ? a && a(window[c]) : h[c] || (h[c] = h[c] || [],
            a && h[c].push(a),
            $.ajax({
                url: b,
                dataType: "script",
  ...
  , Animator = function(b) {
    ...
    d.prototype._animate = function(e, f) {
        if ("undefined" !== typeof f) {
            f = parseInt(f - 1) >> 0,
            this.framePos == e ? (this.framePos > f ? this.framePos-- : this.framePos++,
            this.framePos = f) : this.reverse ? this.framePos == f ? (this.reverse = !1,
            this.framePos > e ? this.framePos-- : this.framePos++) : this.framePos > f ? this.framePos-- : this.framePos++ : this.framePos > e ? this.framePos-- : this.framePos++
        } else {
            if (this.framePos == e) {
  ...
  , GlobalView = {
    _cache: {},
    banner: function() {
        var e = $(".header"), f = e.attr("data-title"), d;
        f && "undefined" != f && (d = $('<div class="banner-title"></div>').text(f).appendTo(e.find(".h-center")),
        $("<div class=\"header-layer\"></div><a class='header-link'></a>").prependTo(e),
        e.find("> .header-layer, > .header-link").height(e.find(".h-center").height()).hover(function() {
            d.addClass("in")
        }, function() {
            d.removeClass("in")
        }));
    ...
    randomPromotion: function() {
        ...
        var t = $("#random_p"), r = [], q = [], p = [], o, n, i, j;
        $.get("//www.bilibili.com/index/index-icon.json", function(c) {
            if (!c.random_link || !c.random_link.length || 0 != c.random_link.recommend.code || 0 != Math.floor(2 * Math.random()) && c.fix.length) {
                c.fix.sort(function(v, f) {
                ...
                for (o = 0; o < c.random.length; o++) {
                    q.push(c.random[o])
                }
                for (n in c.random_link.recommend.list) {
                    if ("object" == typeof c.random_link.recommend.list[n]) {
                        for (i = 0; i < c.random_link.recommend.list[n].length; i++) {
                            r.push(c.random_link.recommend.list[n][i])
                        }
                    }
                }
                j = u(q);
            ...
            if (j && j.link) {
                ...
                var k = $("<div>").addClass("random-p-movie").appendTo(t)
                  , b = j.icon
                  , d = $("<img>");
                if ("bilibili\u7ed9\u60a8\u62dc\u5e74\u5566" == j.title) {
                    var b = "//static.hdslb.com/activity/bnj2016/img/fire1.gif", l = $(), h = $("<div>").css({
                        left: 0
                    }).append($("<img>").css({
                        position: "absolute",
                        right: -35
                        ...
                        position: "absolute",
                        left: 0
                    })), l = l.add(h).add(g), e = !1, a;
                    k.on("mouseenter", function() {
                        e = !0;
                        k.css("cursor", "url(//static.hdslb.com/activity/bnj2016/img/fire2.ico), pointer");
                        a = setTimeout(function() {
                            ...
                            h.css("left", -(h.width() - 50)).find("img").attr("src", utils.trimHttp("//static.hdslb.com/activity/bnj2016/img/fire4.gif"));
                            g.css("right", -(h.width() - 50)).find("img").attr("src", utils.trimHttp("//static.hdslb.com/activity/bnj2016/img/fire3.gif"));
                            0 > h.offset().left && h.width(parseInt($(".header .menu-wrapper").offset().left + 50)).css("left", -(h.width() - 50));
                            g.offset().left + g.width() > $(window).width() && g.width(parseInt($(window).width() - $(".header .menu-wrapper").offset().left - $(".header .menu-wrapper").outerWidth() + 50)).css("right", -(h.width() - 50))
                        }, 100)
                    }).on("mouseleave", function() {
                        e = !1;
                        clearTimeout(a);
                        k.css("cursor", "pointer");
                        l.stop(!0, !0).fadeOut(200, function() {
                            e || l.remove()
                        })
                    })
                }
                d.attr({
                    src: utils.trimHttp(b),
                    alt: j.title
                });
                k.append(d);
                b = -1 != String(j.link).indexOf("search.bilibili.com") ? j.link + "&from_source=gif_recommend" : j.link;
                t.attr({
                    href: b,
                    title: j.title
                });
                c.ea_public && (0 == c.ea_public.code && -1 != c.ea_public.result) && GlobalView.notice(c.ea_public.result)
            } else {
                t.remove()
            }
        })
    ...
    nav: function() {
        ...
        hoverDelay(h.find(".shouji"), function() {
    ...
    menu: function() {
        function b(d) {
            var c;
            d.css("left", 0);
            d.width() + d.offset().left > $(window).width() && (c = -(d.width() + d.offset().left - $(window).width()),
            d.css("left", 0 < c ? 0 : c))
        }
        $(".header .nav-menu").find(".m-i-square").on("mouseenter", function() {
            var f = $(this), a = f.find(".i_num"), e;
    ...
    initSearch: function(g, j, f) {
        var i = $(g).find("form")
          , h = $("[name=keyword]", i);
        j && (g = h.bilibiliSuggestion(j),
        SearchHistory.init(g));
        ...
        f && $.getJSON("//www.bilibili.com/widget/getSearchDefaultWords", function(b) {
...
$(function() {
    $("#random_p").length && (GlobalView.randomPromotion(),
    GlobalView.banner());
    ...
    var i = window.suggestionOpt = {
        ...
        select: function(e, d) {
            ...
            var f;
            d.item.isHistory && (f = i.form.attr("action"),
            i.form.attr("action", i.makeSearchUrl("all")));
            i.form.submit();
            d.item.isHistory && i.form.attr("action", f);
            return !1
        },
        renderMenu: function(n, f) {
            var u = this;
            if ($.isArray(f)) {
                $.each(f, function(a, c) {
                    if (!c.isHistory) {
                ...
                var q = f[r];
                if (q && q.length) {
                    var o = $('<li class="kw"><a href="' + i.makeSearchUrl("all", this.value) + '" target="_blank"><div class="b-line"><p><span>\u5173\u952e\u8bcd</span></p></div></a></li>').appendTo(n);
                    $.each(q, function(d, c) {
                        delete c.url;
                        c.TYPE = r;
                        u._renderItem(o, c);
                ...
                n.find(".b-line").on("mousedown", function(b) {
                    b.preventDefault()
                });
                0 == s && this.close()
            }
    ...
    $('input[placeholder!=""][type=text]').val(function(e, d) {
        ...
        return f ? "" === d ? (this.style.color = "graytext",
        f) : d : this.value
    }));
    bindCardEvent();
    bindPOCoins2($(".v"))
...
function createSuggestSpList(g) {
    ...
    if (0 == suggest_sp.length) {
        ...
        for (j in g + 5 > suggest_sp.length && (g = 0),
        suggest_sp) {
            if (f++,
            !("undefined" != typeof g && f <= g)) {
                var h = suggest_sp[j];
                if ("undefined" != typeof h && "undefined" != typeof h[0] && ($('<li><a href="/sp/' + h[0] + '"><img src="' + utils.trimHttp(h[1]) + '" title="' + h[0] + '"><div class="name">' + h[0] + '</div></a><div class="info">' + (h[2] ? "\u540c\u4e49\u8bcd: <i>" + h[2] + "</i>" : "") + "<p>\u5171<b>" + h[3] + "</b>\u4e2a\u89c6\u9891</p></div></li>").appendTo("#rup_sp"),
                5 <= ++i)) {
                    break
                }
            }
...
function insertFlash(f, h, e, g) {
    document.getElementById(f) && (h = '<embed height="' + g + '" width="' + e + '" id="' + f + '_flash" pluginspage="//www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" allowscriptaccess="always" style="visibility:hidden"  src="' + h + '" type="application/x-shockwave-flash" allowfullscreen="true" quality="high">',
...
function loadNotify() {
    ...
    insertFlash("cb_controler", "//static.hdslb.com/images/bili_notify.swf", 0, 0),
        ...
        $.ajax(lastPage, {
            success: function(c) {
                ...
                500 > e ? setTimeout(function() {
                    $("#atme.atlist").html(c);
                    bindCardEvent()
                }, 0 >= 300 - e ? 10 : 300 - e) : ($("#atme.atlist").html(c),
                bindCardEvent())
            }
        })
    }
        ...
        $.ajax(lastPage, {
            success: function(c) {
                ...
                500 > e ? setTimeout(function() {
                    ...
                    bindCardEvent()
                }, 0 >= 300 - e ? 10 : 300 - e) : ($("#dynlist.atlist").html(c),
                bindCardEvent())
            }
        })
    }
...
var CoverPreview = function(b) {
    ...
    d.prototype = {
        ...
        bind: function() {
            utils.browser.lteIE(9) || this.options.multiPrevent && "true" == b(this.options.mount).attr("data-cover-preview") || (b(this.options.mount).attr("data-cover-preview", "true"),
            this._mouseEvent())
        },
        ...
        _buildPreview: function(a, n) {
            ...
            ,
            k.src = utils.trimHttp(n.image[0]),
            !b.isArray(this.cache[l]))) {
        ...
        _cacheArray: function(h, l) {
            var k = 0
              ...
              , i = [];
            if (h.length > l) {
                for (100 < h.length && (h.length = 100),
                j = Math.floor(h.length / l),
                k = 0; k < h.length && !(i.push(h[k]),
                i.length >= l); k += j) {}
            } else {
                i = h
            }
...
$(document).ready(function() {
    $("[data-fn-size]").each(function() {
        ...
        f[0] && e && ($(this).attr("src", utils.thumbnail(e, f[0], f[1])),
        $(this).removeAttr("data-fn-size data-fn-src"))
    });
    var b = "";
    ...
    $.ajax({
        ...
        success: function(a) {
            if (a && 0 === a.code && (a = a.data[0]) && a.pic && a.url) {
                ...
                $(".header .header-layer").length ? h = $(".header .header-layer") : (h = $('<div class="header-layer"></div>'),
                c.prepend(h));
                a.name && ($(".header .banner-title").length ? g = $(".header .banner-title").text(a.name) : (g = $('<div class="banner-title">' + a.name + "</div>"),
                $(".header .h-center ").append(g)));
...
$(document).ready(function() {
    ...
    if (void 0 != window.pageLoadStart) {
        var e, g;
        if ("//www.bilibili.com/" == location.href || "https://www.bilibili.com/" == location.href || "//www.bilibili.com/account/dynamic" == location.href || "https://www.bilibili.com/account/dynamic" == location.href) {
            window.performance && window.performance.timing ? f() : (e = (Date.now ? Date.now() : (new Date).getTime()) - pageLoadStart,
            h())
        }
    }
});
$(document).ready(function() {
    /MSIE 8/.test(navigator.userAgent) && $("body").prepend("<div id='the-IE-tip'>\u4e3a\u4e86\u4fdd\u62a4\u4f60\u7684\u8d26\u53f7\u5b89\u5168\uff0cbilibili\u5373\u5c06\u4e0d\u652f\u6301IE8\u53ca\u4ee5\u4e0b\u7248\u672c\u6d4f\u89c8\u5668\u8bbf\u95ee\uff0c\u5efa\u8bae\u4f60\u5347\u7ea7\u5230IE\u6700\u65b0\u7248\u672c\u6d4f\u89c8\u5668\uff0c\u6216\u4f7f\u7528Chrome\u7b49\u5176\u4ed6\u6d4f\u89c8\u5668\u3002</div>")
});
(function(b) {
    var d = b.ajax;
    b.ajax = function(a, c) {
